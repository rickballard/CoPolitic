...
$ErrorActionPreference="Stop"; $readme = Join-Path $RepoRoot "README.md"; $src = Join-Path $RepoRoot "status\codrift.json"
...
$text = if(Test-Path $readme){ Get-Content $readme -Raw } else { "# CoPolitic`n" }
