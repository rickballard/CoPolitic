# CoSteward – civic AI transition role (canonical)

> This is the canonical spec for the CoSteward role.  
> Older references may still point at a legacy filename; treat **CoSteward** as the current name.

# CoSteward  -  Transition Office Steward (AI pivots)
